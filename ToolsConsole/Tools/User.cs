...
namespace Tools
{
    public class User
    {
        ...
        {
            string guid = Tools.Tool.CookieHelper.GetValue("USERGUID");
            if (guid == null || guid == "")
            {
                guid = System.Guid.NewGuid().ToString();
                Tools.Tool.CookieHelper.SetObj("USERGUID", 1, guid, Tools.Special.Common.GetDomain());
            }
            return guid;
        }
        ...
        public static void SetRemember(int userId, string userName, bool remember)
        {
            ...
            //添加Cookie
            Tools.Tool.CookieHelper.SetObj("Auth", authStr);
        ...
        {
            int userId = 0;
            string authCookie = Tools.Tool.CookieHelper.GetValue("Auth");
        ...
        {
            Tools.Tool.CookieHelper.Del("Remember");
            Tools.Tool.CookieHelper.Del("Auth");
        ...
        {
            string listRecord = Tools.Tool.CookieHelper.GetValue("ViewRecord");
            ...
            Tools.Tool.CookieHelper.SetObj("ViewRecord", Tools.Tool.JsonHelper.Serialize(list));
        }
