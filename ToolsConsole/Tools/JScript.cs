...
namespace Tools
{
    public class JScript
    {
        ...
        {
            string url1 = "http://www.efu.com.cn/404/error.html";
            System.Web.HttpContext.Current.Response.StatusCode = 301;
            System.Web.HttpContext.Current.Response.Status = "301 Moved Permanently";
            System.Web.HttpContext.Current.Response.AddHeader("Location", url1);
            System.Web.HttpContext.Current.Response.End();
        }
        public static void Show404(string url)
        {
            string url1 = url;
            if (string.IsNullOrEmpty(url1) == true)
            {
                url1 = "http://www.efu.com.cn/404/error.html";
            }
            System.Web.HttpContext.Current.Response.StatusCode = 301;
            System.Web.HttpContext.Current.Response.Status = "301 Moved Permanently";
            System.Web.HttpContext.Current.Response.AddHeader("Location", url1);
        ...
        public static void Show4044()
        {
            //string dirname = "E:\\www2\\efuhtml\\404\\4042.html";
            string dirname = ConfigurationManager.AppSettings["error404"];
            string str = string.Empty;

            using (StreamReader reader = new StreamReader(dirname, Encoding.GetEncoding("GB2312")))
            {
